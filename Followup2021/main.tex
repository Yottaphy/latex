...
\begin{frame}{\textsc{Simulations}}
    \begin{textblock*}{12cm}(0.5cm,1.5cm)
        Performing simulations using Simion to study transmission rates through the MARA-LEB RFQs for different parameters. 

        \includegraphics[angle=20,scale=0.3]{RFQ.pdf}
    \end{textblock*}    
\end{frame}
