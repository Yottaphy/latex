...
\textbf{Radio-Frequency Quadrupoles} (RFQ) use alternating electric fields, at varying frequencies, to trap particles within a confined space. Particles inside an RFQ experience a force upon them \cite{traps}:
\begin{equation}
    \label{eq:rfq}
