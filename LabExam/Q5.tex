...
In all, aluminium and nitrogen are at a 1:1 ratio to each other when considering both N isotopes. The \ce{^{14}N}:\ce{^{15}N} ratio is the same as the ratio of their natural abundances, 249:1. 
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{composition.png}
