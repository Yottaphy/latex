...
A recent experiment has been carried out using the MARA separator to investigate the production of isotopes in MARA-LEB's region of interest close to \ce{^{96}Ag}. The charge state distribution of \ce{^{96}Pd} recoils at the focal plane of MARA will help to finalise design aspects concerning the size of the gas cell window. In this contribution, a general overview of the MARA-LEB facility along with preliminary results of the experiment will be given.
